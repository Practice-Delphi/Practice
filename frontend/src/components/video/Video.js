                    ...
                    <div className="Video-inner">
                        <div className="Video-main">
                            <div className="Video-container">
                                ...
                                <iframe title="Video" className="Video-frame" src={`${this.props.status.url}?autoplay=1&cc_load_policy=1&controls=1&disablekb=0&enablejsapi=0&fs=1&iv_load_policy=1&loop=0&rel=0&showinfo=1&start=0&wmode=transparent&theme=dark"`}></iframe>
                            </div>
                        </div>
                    </div>
                </div>
